...
public class exp4 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String query1 = "INSERT INTO emp " + "VALUES (101, 'Prathyusha', 50000, 'CSE')";
			stmt.executeUpdate(query1);
			query1 = "INSERT INTO emp " + "VALUES (102, 'Praneetha', 59000, 'IT')";
			stmt.executeUpdate(query1);
...
102	Sahithi	59000	IT
101	Deepika	10000	EEE
101	Harshitha	42000	MECH
